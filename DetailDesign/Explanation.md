- [設計解説資料](#設計解説資料)
  - [概要について](#概要について)
    ...
    - [\[Create visualizer resource\]](#create-visualizer-resource)
      - [\[audio\_wav\_encoder\]](#audio_wav_encoder)
      - [\[wave\_visualizer\_generator\]](#wave_visualizer_generator)
